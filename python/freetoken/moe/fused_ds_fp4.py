...
def routed_experts_fp4_prefill(
    ...
    T, top_k = slots.shape
    # The grouped kernel and its static tile were designed around H100 WGMMA.
    # ROCm keeps the portable per-route implementation, which consumes the
    # same packed banks and has the same public semantics.
