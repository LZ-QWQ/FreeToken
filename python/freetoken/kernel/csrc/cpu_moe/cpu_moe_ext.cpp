Warning: truncated output (original token count: 25647)
Total output lines: 2150
...
inline __m256 dsfp4_half_avx2(const uint8_t* pk, const float* xeb, const float* xob, __m256 mag8) {
  __m256i wi = _mm256_cvtepu8_epi32(_mm_loadl_epi64(reinterpret_cas…5647 tokens truncated…h size) pair -- the Python side
