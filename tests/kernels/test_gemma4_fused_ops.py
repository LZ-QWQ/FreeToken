...
def test_gemma4_router_uses_sgl_kernel_topk_softmax_semantics():
    ...
    if torch.version.hip is None:
        ...
        # torch.topk does not specify which expert wins a boundary tie. ROCm and
        # the deterministic Triton router may return different IDs for equal bf16
        # logits, so compare the selected scores and their corresponding weights.
