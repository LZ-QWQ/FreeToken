...
def test_chunked_prefill_matches_one_shot(cut: int):
    ...
    if torch.version.hip is None:
        ...
        # The one-shot and chunked calls use different GEMM batch shapes.
        # ROCm may round their bf16 projections differently even though both
        # paths independently match the fp32 dense oracle above.
